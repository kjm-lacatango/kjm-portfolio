  ...
  return (
    <div className='w-full h-full relative flex items-center overflow-hidden'>
      ...
      <FontAwesomeIcon icon={faAngleLeft} onClick={showPrev}
        className='absolute left-0 cursor-pointer mx-2 text-cyan-800 px-4 py-3 hover:px-2.5 hover:py-1.5 shadow-sm shadow-gray-500 backdrop-blur-sm rounded-full hover:text-xl duration-200' />
      <FontAwesomeIcon icon={faAngleRight} onClick={showNext}
        className='absolute right-0 cursor-pointer mx-2 text-cyan-800 px-4 py-3 hover:px-2.5 hover:py-1.5 shadow-sm shadow-gray-500 backdrop-blur-sm rounded-full hover:text-xl duration-200' />
